...
#include "../PC_Application/CustomWidgets/informationbox.h"
...
struct qt_meta_stringdata_InformationBox_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_InformationBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_InformationBox_t qt_meta_stringdata_InformationBox = {
    {
QT_MOC_LITERAL(0, 0, 14) // "InformationBox"
...
QT_INIT_METAOBJECT const QMetaObject InformationBox::staticMetaObject = { {
    &QMessageBox::staticMetaObject,
    qt_meta_stringdata_InformationBox.data,
    qt_meta_data_InformationBox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *InformationBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_InformationBox.stringdata0))
